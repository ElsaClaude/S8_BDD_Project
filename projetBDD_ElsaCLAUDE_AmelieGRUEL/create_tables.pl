...
# creation de la table Caracteristiques Generales UniProt
...
# creation de la table Informations Genes UniProt
...
#creation de la table Reactions_EnsemblPlants
